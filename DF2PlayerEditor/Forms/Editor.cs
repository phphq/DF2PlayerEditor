...
namespace DF2PlayerEditor.Forms
{
    public partial class Editor : Form
    {
        ...
        private void DrawTextBoxLines(object sender, PaintEventArgs e)
        {
            ...
            var p = new Pen(Color.FromArgb(255, 202, 68, 9), 1);
            var g = e.Graphics;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var playerOffset = Config.PlayerStartOffset + (Config.PlayerNextOffset * LoadedPlayer.Index);
            ...
            {
                var macroOffset = playerOffset + Config.PlayerMacroOffset + (Config.PlayerMacroNextOffset * i);
            ...
            var result = FileFunctions.WriteToSaveFile(Path.Combine(LoadedGamePath, Config.PlayerFile), writeData);
