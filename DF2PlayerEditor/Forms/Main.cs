...
using DF2PlayerEditor.Classes;
using DF2PlayerEditor.Properties;
...
namespace DF2PlayerEditor.Forms
{
    public partial class Main : Form
    {
        ...
        private void DrawListBoxBorder(object sender, PaintEventArgs e)
        {
            ...
            lbBorder.DrawRectangle(new Pen(Color.FromArgb(255, 202, 68, 9), 1), 11, 26, 253, 68);
            lbBorder.Dispose();
        }
            ...
            if (GameConfig.ContainsKey("game_res"))
            {
                ...
                switch (gameRes)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        lblSetResolutionText.Text = "1280x960";
                        break;
                    default:
        ...
        private void btnSetRes1280_Click(object sender, EventArgs e)
        {

            var result = MessageBox.Show("This resolution is buggy and can cause buildings to float and/or disappear completely on some maps. Are you sure this is the resolution you want?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

            if (result != DialogResult.Yes)
                return;

            GameConfig["game_res"] = "7";
            btnSaveConfig.Enabled = true;
        }
        ...
        private void btnFindGame_Click(object sender, EventArgs e)
        {
            ...
            using (var fbd = new FolderBrowserDialog())
            {
                ...
                {
                    MessageBox.Show(Config.ConfigFile + " or " + Config.PlayerFile + " is missing from " + fbd.SelectedPath + ". Please try opening and closing the game first, or select a different path.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ResetAllFields();
                    return;
                }
